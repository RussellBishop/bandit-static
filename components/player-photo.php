...
<div class="u-pos-relative">
    ...
    <div class="c-player-photo u-width-<?=(!empty($navPlayer)) ? '3' : '2'?>bl" aria-hidden="true" style="background-image: url('https://randomuser.me/api/portraits/men/<?=rand(1,100)?>.jpg');">
