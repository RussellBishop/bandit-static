<div class="u-pos-relative">
    ...
    <div class="o-scroll-overflow">
        <ul class="u-flex u-ph-1bl u-hspace-1bl">
            ...
            <li><a href="/results.php" class="c-tab c-tab--<?=($page==='results'?'active':'inactive')?>">Results</a></li>
            ...
            <li><a href="/club-info.php" class="c-tab c-tab--<?=($page==='club'?'active':'inactive')?>">Club</a></li>
